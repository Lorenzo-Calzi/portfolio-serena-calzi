    ...
    return (
        <section id="courses-list">
            <div className="courses">
                {courses &&
                    courses
                        .filter((course: CourseProps) =>
                            selectedEvent ? course.title === selectedEvent : course
                        )
                        .map((course: CourseProps, index: number) => (
                            <div
                                key={index}
                                className="course"
            ...
            <form
                ...
                onSubmit={
                    editCourseObj.id ? e => editCourse(e, editCourseObj.id) : e => createCourse(e)
                }
            ...
            >
                ...
                <div className="row">
                    ...
                    <div>
                        <input
                            {...register("startTimetables")}
                            type="time"
                            id="startTimetables"
                            name="startTimetables"
                        />
                        <input
                            {...register("endTimetables")}
                            type="time"
                            id="endTimetables"
                            name="endTimetables"
                        />
                ...
                <div className="row">
                    ...
                    <select
                        {...register("formElementsList")}
                        name="formElementsList"
                        id="formElementsList"
                        multiple
                    >
