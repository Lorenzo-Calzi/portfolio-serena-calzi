...
const ServiceDetails = () => {
    ...
    const currentIndex = ServicesSTUB.findIndex(
        service => service.title.toLowerCase() === nomeServizio?.replaceAll("-", " ")
    );
    ...
    return currentIndex !== -1 ? (
        <div className="service-details">
            <Header
                components={
                    <Breadcrumb
                        title={nomeServizio ? nomeServizio.replaceAll("-", " ") : "Servizio"}
                    />
                }
            />
                ...
                {currentIndex !== -1 && ServicesSTUB[currentIndex].details && (
                    <div className="service-content">
                            ...
                            <div className="details">
                                <div className="detail">
                                    ...
                                    <div className="right">
                                        ...
                                        {ServicesSTUB[currentIndex].details.date.map(
                                            (date, index) => (
                                                <Text type={"p-medium"} key={index}>
                                                    {ServicesSTUB[currentIndex].details.date
                                                        .length > 1 && "•"}{" "}
                                                    {date}
                                                </Text>
                                            )
                                ...
                                <div className="detail">
                                    ...
                                    <div className="right">
                                        ...
                                        <Text type={"p-medium"}>
                                            {ServicesSTUB[currentIndex].details.target}
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div className="detail">
                                    <img
                                        src={PerformanceTypeIcon}
                                        alt="Icona del tipo di performance"
                                    />

                                    <div className="right">
                                        <Text type={"span"}>Tipo di prestazione:</Text>
                                        <Text type={"p-medium"}>
                                            {ServicesSTUB[currentIndex].details.performanceType}
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div className="detail">
                                    ...
                                    <div className="right">
                                        ...
                                        <Text type={"p-medium"}>
                                            {ServicesSTUB[currentIndex].details.placesAvailable}
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div className="detail">
                                    ...
                                    <div className="right">
                                        ...
                                        <Text type={"p-medium"}>
                                            {ServicesSTUB[currentIndex].details.mode}
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div className="detail">
                                    ...
                                    <div className="right">
                                        ...
                                        <Text type={"p-medium"}>
                                            {ServicesSTUB[currentIndex].details.timetables}
                                        </Text>
                                    </div>
                                </div>
                                ...
                                <div className="detail">
                                    ...
                                    <div className="right">
                                        ...
                                        <Text type={"p-medium"}>
                                            {ServicesSTUB[currentIndex].details.days}
                                        </Text>
                                    </div>
                                </div>
                        ...
                        <div className="description">
                            ...
                            <Text type={"p-medium"}>
                                {ServicesSTUB[currentIndex].details.description}
                            </Text>
                        </div>
