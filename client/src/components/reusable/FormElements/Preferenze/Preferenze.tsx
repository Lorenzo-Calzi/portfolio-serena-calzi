...
const Preferenze = ({ register, errors }: PreferenzeProps) => {
    ...
    const options = [
        "In gruppo con altre mamme nelle date e nella sede proposta dall'insegnante",
        "Individuale presso il mio domicilio (indicare la via, n.civico, paese e campanello)",
        "Online"
    ];
