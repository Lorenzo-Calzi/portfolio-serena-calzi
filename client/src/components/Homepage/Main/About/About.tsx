            ...
            <div className="page-container">
                <div className="content">
                    <div className="copies">
                        ...
                        <div>
                            <Text type={"p-big"} fontWeight={700}>
                                PEDAGOGISTA, SPECIALIZZATA IN PEDAGOGIA CLINICA:
                            </Text>
                            <Text type={"p-big"}>
                                Iscritta al registro interno dell’associazione UNIPED con n. 22459
                                S0
                            </Text>
                        </div>
                        ...
                        <div>
                            <Text type={"p-big"} fontWeight={700}>
                                INSEGNANTE DI MASSAGGIO INFANTILE ABILITATA:
                            </Text>
                            <Text type={"p-big"}>Iscritta ad AIMI Lombardia con n. 9853</Text>
                        </div>
